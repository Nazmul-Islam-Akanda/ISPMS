...
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
    ...
    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count" style=background-color:#DED725>
        ...
        <div class="count" style=color:#2A2350><b>{{$count['customers']}}</b></div>
        <span class="count_bottom"><i class="green"> </i></span> 
    </div>
    &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
    ...
    Total Payments</span>
        <div class="count green" style=color:#FFFFFF><b>{{$count['payments']}}</b></div>
        <span class="count_bottom"><i class="green"></i> </span>
    </div>
...
<br><br>
    ...
    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count" style=background-color:#25310C>
        ...
        <div class="count" style=color:#FFFFFF><b>{{$count['complains']}}</b></div>
    ...
    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count" style=background-color:#AADD37>
        ...
        Total Blocks </span>
        <div class="count" style=color:#2A2350><b>{{$count['blocks']}}</b></div>
        <span class="count_bottom"><i class="green"> </i> </span>
    </div>
    &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count" style=background-color:#325324>
        ...
        Total Packages </span>
        <div class="count" style=color:#DED725><b>{{$count['packages']}}</b></div>
        <span class="count_bottom"><i class="green"></i></span>
    </div>
