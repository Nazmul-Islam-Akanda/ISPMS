...
<header class="header header-light bg-white">
    ...
    <div class="navbar-brand-wrapper col-auto">
      ...
      <h4 style="color:yellow"><b>Catch Net Ltd.</b></h4>
      <!-- Company Name -->
    </div>
            ...
            <section class="border-bottom p-3 p-md-4">
              ...
              <div class="d-flex">
                <div class="position-relative mr-3">
                  ...
                  <img class="avatar-lg rounded-circle" src="{{url('jpg/img11.jpg')}}" alt="Image description">
                </div>

                <div class="position-relative mr-3">
                  <span class="indicator indicator-success indicator-lg indicator-bordered-reverse indicator-top-left rounded-circle"></span>
                  <img class="avatar-lg rounded-circle" src="{{url('jpg/img7.jpg')}}" alt="Image description">
                </div>

                <div class="position-relative">
                  <span class="indicator indicator-success indicator-lg indicator-bordered-reverse indicator-top-left rounded-circle"></span>
                  <img class="avatar-lg rounded-circle" src="{{url('jpg/img10.jpg')}}" alt="Image description">
                </div>
              </div>
            </section>
